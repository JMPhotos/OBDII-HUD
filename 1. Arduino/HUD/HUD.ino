/*=========================================================================
    HUD -      This program is designed to illuminate a series of 18 NeoPixel
...
#define MODE_LED_BEHAVIOUR          "SPI"            //Flash the built-in LED on bluetooth transfer                             
...
/* Read EEPROM and Configure HUD */
  Configure_HUD();        //Initialize some of the basic HUD settings
  testRPM = 650;          //Set the starting point for the Test Mode RPM
}
